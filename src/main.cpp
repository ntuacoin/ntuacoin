...
const string strMessageMagic = "ntuacoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // ntuacoin: 1 days
static const int64 nTargetSpacing = 120; // ntuacoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ntuacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ntuacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbb46b3b0c3672308914f5fd276d700b461f1658392f1e60c1bc1890d65ce97b5");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Don't  try this at home";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1509350608; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;

        if (fTestNet)
        {
            block.nTime    = 1509350608;
            block.nNonce   = 762316;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8cf56f9b3743d40cea4a242b62f90766b5629317855a9e779366e1288d7e5458"));
